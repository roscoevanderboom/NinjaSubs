  ...
  const handleIgnoreUser = () => {
    if (
      ...
      handleProfileData({
        ...
        user: state.user,
        data: {
          blackList: add_if_not_included(state.profileData.blackList, sub.uid),
        },
      });
      setAnchorEl(null);
    }
  ...
  return (
    <div>
      ...
      <Menu
        ...
        onClose={handleClose}
      >
        <MenuItem className={classes.listItem} onClick={handleIgnoreUser}>
          Ignore user
        </MenuItem>
      </Menu>
    </div>
