      ...
      <Card plain>
        ...
        <CardBody>
          <p className={classes.description}>
            "Knowing the mouse might one day leave its hole and get the
            cheese... fills you with great determination." - I am from Taiwan
            and I have been a web developer for several years. Also, I am crazy
            for gaming! Someday I'm hoping to leave the comfort of my mousehole
            and get the cheese!
          </p>
        </CardBody>
