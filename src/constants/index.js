...
export const terms =
  "https://www.termsandconditionsgenerator.com/live.php?token=cUjuC2S5w2vTipxpiAQVx56WBJZReus7";
export const privacy_policy =
  "https://www.privacypolicytemplate.net/live.php?token=G1ODSTh6D6xdPVL2vUrNtMLouRykOV2O";
//
...
export const isArrayEqual = (array1, array2) =>
  array1.length === array2.length && array1.every((x) => array2.includes(x));
